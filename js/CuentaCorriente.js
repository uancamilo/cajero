class CuentaCorriente {
	async transferir(datosTransferencia) {
		...
		// Verificar si el saldo permite sobregiro hasta $500
		const limiteSobregiro = -500; // Saldo mínimo permitido
		if (saldoCuentaActual - montoTransferencia >= limiteSobregiro) {
			...
			console.log(
				"No se puede realizar la transferencia: el sobregiro supera el límite permitido."
			);
		}
	}
}
